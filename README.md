...
<!-- description-start -->
This is the official GitHub repo for the DarkUtilities mod. A bit of everything. You can download this mod from [CurseForge](https://www.curseforge.com/minecraft/mc-mods/dark-utilities) or [Modrinth](https://modrinth.com/mod/dark-utilities). Please report issues [here](https://github.com/Darkhax-Minecraft/Dark-Utilities/issues).
<!-- description-end -->
...
DarkUtilities is proudly sponsored by Nodecraft! Play your favorite games with your friends using their high
