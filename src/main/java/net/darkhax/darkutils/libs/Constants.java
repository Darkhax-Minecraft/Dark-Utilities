...
public class Constants {
    ...
    public static final String VERSION_NUMBER = "1.1.1.0";
    ...
    public static final String DEPENDENCIES = "required-after:bookshelf@[1.2.1.251,];after:Waila;after:JEI@[3.4.0.204,];";
